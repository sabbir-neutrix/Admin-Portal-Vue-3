<template>
    <div class="drop-shadow bg-white p-4 md:p-8">
      <div class="flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="">
            <router-link to="/add-employee" class="text-sm md:text-base font-medium px-4 md:px-6 py-2 md:py-4 bg-slate-400 text-white rounded-md">+ Add New Employee</router-link>
        </div>
      </div>
